                ...
                <div class="p-6 justify-center text-center">
                    <form  @submit.prevent="$emit('onSubmit', $event.target.click)" >
                        ...
                        <div class="mb-6">
                            ...
                            <p v-if="errors.deadline" class="mt-2 text-sm text-red-600 dark:text-red-500"><span
                                class="font-medium">Oh, snapp!</span> {{ errors.deadline }}.</p>
                        </div>
                        <div class="mb-6">
                            ...
                            <p v-if="errors.title || validateE" class="mt-2 text-sm text-red-600 dark:text-red-500"><span
                                class="font-medium">Oh, snapp!</span> {{ errors.title || validateE }}.</p>
                        </div>
                        <button type="submit"
...
export default {
    name: "TheModal",
    props:['title','deadline','status', 'errors','btnName',],
    emits:['update:status','update:title','update:deadline','update:status', 'onSubmit'],
    setup() {
        const closeModal = ()  => {
